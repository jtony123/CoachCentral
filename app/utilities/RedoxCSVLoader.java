...
public class RedoxCSVLoader {
	...
	public void loadCSVFile(String fileName) {
		...
		try {
			...
			int nameindex = headerstrings.indexOf("athlete");
			int testtime = headerstrings.indexOf("Blood Test Time");
			
			int ford = headerstrings.indexOf("Free Oxygen Radicals Defence");
			int fort = headerstrings.indexOf("Free Oxygen Radicals Test");
...
//		String fordavg = "fordavg";
//		String fortavg = "fortavg";
//		String fordavgadj = "fordavgadj";
//		String fortavgadj = "fortavgadj";
		...
		while (it.hasNext()) {
			...
			for(String s : entries){
				...
				Double fordreading = Double.parseDouble(tokens[2]);
				Double fortreading = Double.parseDouble(tokens[6]);
